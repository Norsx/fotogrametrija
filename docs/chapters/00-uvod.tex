...
U poglavlju \ref{sec:teorija} iznesena je teorijska podloga: princip korelacije,
model kamere i projekcijske matrice, stereo triangulacija te računanje površinskih

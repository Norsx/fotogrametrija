...
\usepackage{cmap}           % Omogućuje kopiranje teksta s našim znakovima iz PDF-a
\usepackage{iftex}
\ifPDFTeX
    \usepackage[utf8]{inputenc}
    \usepackage[T1]{fontenc}
    \usepackage{lmodern}        % Pomoćni font za T1 encoding (č, ć, ž, š, đ)
\else
    \usepackage{fontspec}
\fi
...
\usepackage{amssymb}
\ifPDFTeX
    \usepackage{tgtermes}       % Times New Roman font (pdfTeX)
\else
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Student Studic}}
...
\begin{titlepage}
    ...
    \vfill
    {\fontsize{28pt}{34pt}\selectfont\bfseries Test Kolegij\\}
    \vspace{0.5cm}
    {\fontsize{28pt}{34pt}\selectfont\bfseries SEMINAR\\}
    \vspace{1.5cm}
    {\fontsize{16pt}{19pt}\selectfont\bfseries Testni Seminar\\}
    \vfill
    \noindent
    \begin{minipage}[t]{0.48\textwidth}
        \raggedright
        {\fontsize{14pt}{17pt}\selectfont Profesor:\\}
        {\fontsize{14pt}{17pt}\selectfont Prof. Profesor\\}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \raggedleft
        {\fontsize{14pt}{17pt}\selectfont Student:\\}
        {\fontsize{14pt}{17pt}\selectfont\bfseries Student Studic\\}
    \end{minipage}
    \vspace{1cm}
    \begin{center}

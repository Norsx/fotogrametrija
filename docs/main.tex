...
\begin{titlepage}
  ...
  \begin{tabular}{p{0.45\textwidth}>{\raggedleft\arraybackslash}p{0.45\textwidth}}
    \textmd{Profesor:} & \textmd{Studenti:} \\[0.3cm]
    \textbf{\professorname} & \textbf{Marko Bakotić} \\
    & \textbf{Tin Dolenčić} \\
    & \textbf{Lucijan Fišter} \\
...
\input{chapters/01-teorijska-podloga}
\input{chapters/02-metodologija}
\input{chapters/03-implementacija}
\input{chapters/04-rezultati}

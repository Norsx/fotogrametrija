...
static emlrtRSInfo ge_emlrtRSI{
    ...
    "sortIdx", // fcnName
    "C:\\Program "
    "Files\\MATLAB\\R2024a\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" // pathName
};
...
static emlrtRTEInfo uc_emlrtRTEI{
    ...
    "sortIdx", // fName
    "C:\\Program "
    "Files\\MATLAB\\R2024a\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" // pName
};
             ...
             array<int32_T, 1U> &idx)
{
  ...
  bLen2 = x.size(0);
  idx.set_size(&uc_emlrtRTEI, &sp, bLen2);
  for (i = 0; i < bLen2; i++) {
    idx[i] = 0;
  }
  if (x.size(0) != 0) {
    ...
    int32_T wOffset_tmp;
    st.site = &ge_emlrtRSI;
    iwork.set_size(&vc_emlrtRTEI, &st, bLen2);
    for (i = 0; i < bLen2; i++) {
      iwork[i] = 0;
    }
    xwork.set_size(&wc_emlrtRTEI, &st, bLen2);

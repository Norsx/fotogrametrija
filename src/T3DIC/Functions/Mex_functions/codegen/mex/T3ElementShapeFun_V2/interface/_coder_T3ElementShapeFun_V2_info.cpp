//
// _coder_T3ElementShapeFun_V2_info.cpp
//
// Code generation for function 'T3ElementShapeFun_V2'
//

// Include files
#include "_coder_T3ElementShapeFun_V2_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("T3ElementShapeFun_V2"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("C:\\Users\\Admin\\OneDrive - Fakultet strojarstva i "
                          ...
                          "unctions\\T3ElementShape"
                          "Fun_V2.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739599.60309027776));
...
// End of code generation (_coder_T3ElementShapeFun_V2_info.cpp)
